...
class FamilyRequestScreen extends StatefulWidget {
  const FamilyRequestScreen({Key? key,required this.id}) : super(key: key);
  final String id;

  @override
  _FamilyRequestScreenState createState() => _FamilyRequestScreenState();
}
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Flexible(
              child: StreamBuilder(
                stream: getFamilyAllRequest(year, widget.id),
      ...
      appBar: AppBar(title: Text('Requests'),backgroundColor: kprimarycolor,),
    );
  }
}
class PatientRequestContainer extends StatefulWidget {
  const PatientRequestContainer({Key? key,required this.index,required this.snapshot,required this.uid}) : super(key: key);
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: !checkSelect?null:()async{
                                ...
                                FamilychangeAccess(widget.uid,widget.snapshot.docs[widget.index]['Request id'], accessType!,docId, context);
