...
class PatientPrescription extends StatefulWidget {
  const PatientPrescription({Key? key,required this.patientId}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Flexible(
              child: StreamBuilder(
                stream: getPatientPrescriptionData(year, widget.patientId),
                builder: (context, AsyncSnapshot snapshot){
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context,int index){
                      if(search.isEmpty)
                      {
                        return CustomPatientPrescriptionCard(
...
class CustomPatientPrescriptionCard extends StatelessWidget {
  const CustomPatientPrescriptionCard({super.key, required this.snapshot,required this.index});
  final int index;
