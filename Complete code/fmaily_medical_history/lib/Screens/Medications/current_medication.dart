...
class CurrentMedicationScreen extends StatefulWidget {
  const CurrentMedicationScreen({Key? key}) : super(key: key);

  @override
  _CurrentMedicationScreenState createState() =>
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Flexible(
            child: StreamBuilder(
              stream: getCurrentMedicationData(),
              builder: (context, AsyncSnapshot snapshot){
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context,int index){
                    if(mName.isEmpty)
                    {
                      return CurrentMedicationContainer(
...
class CurrentMedicationContainer extends StatelessWidget {
  const CurrentMedicationContainer({Key? key,required this.snapshot,required this.index}) : super(key: key);
  final int index;
