...
class EditMedication extends StatefulWidget {
  const EditMedication({Key? key,required this.medicineName,required this.endDate,required this.startDate, required this.contactNo,required this.disease, required this.doctorName,required this.hAddress,required this.hospitalName,required this.schedule,required this.specialization,required this.docId}) : super(key: key);
                      ...
                      child: ElevatedButton(
                        onPressed: textReadOnly?null:(){
                          ...
                          if(!_form.currentState!.validate())
                          {
                            ...
                            editMedication(dName.text, dSpecialization.text, dNumber.text, dHospital.text, dHAddress.text, disease.text, medicine.text, takeFood, startDate.text, endDate.text, context, widget.docId);
                            setState(() {
                              textReadOnly=true;
                            });
                          }
