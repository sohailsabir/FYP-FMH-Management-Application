...
class FamilyEmailVerificationScreen extends StatefulWidget {
  const FamilyEmailVerificationScreen({Key? key,required this.app}) : super(key: key);
  final FirebaseApp app;

  @override
  State<FamilyEmailVerificationScreen> createState() =>
      _FamilyEmailVerificationScreenState();
}

class _FamilyEmailVerificationScreenState extends State<FamilyEmailVerificationScreen> {
