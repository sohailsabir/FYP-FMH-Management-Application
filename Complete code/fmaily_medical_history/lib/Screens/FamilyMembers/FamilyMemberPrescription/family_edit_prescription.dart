...
class FamilyEditPrescription extends StatefulWidget {
  const FamilyEditPrescription({Key? key,required this.disease,required this.hName,required this.dName,required this.exitingUrl,required this.docId,required this.prescriptionId,required this.familyMemberId}) : super(key: key);
  ...
  @override
  _FamilyEditPrescriptionState createState() => _FamilyEditPrescriptionState();
}

class _FamilyEditPrescriptionState extends State<FamilyEditPrescription> {
                      ...
                      if(imageFile==null)
                      {
                        ...
                        try{
                          ...
                          if (result.isNotEmpty && result[0].rawAddress.isNotEmpty){
                            updateFamilyPrescriptionImage(imageFile!, dName.text, hName.text, disease.text, context, widget.exitingUrl, widget.docId,widget.familyMemberId,widget.prescriptionId);
                          }
