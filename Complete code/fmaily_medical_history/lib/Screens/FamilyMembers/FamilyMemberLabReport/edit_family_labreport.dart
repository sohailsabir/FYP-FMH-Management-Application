...
class EditFamilyLabReport extends StatefulWidget {
  const EditFamilyLabReport({Key? key,required this.lName,required this.reportTitle,required this.docId,required this.existingUrl,required this.reportId,required this.familyMemberId}) : super(key: key);
  ...
  @override
  _EditFamilyLabReportState createState() => _EditFamilyLabReportState();
}

class _EditFamilyLabReportState extends State<EditFamilyLabReport> {
                      ...
                      if(imageFile==null)
                      {
                        ...
                        try{
                          ...
                          if (result.isNotEmpty && result[0].rawAddress.isNotEmpty){
                            updateFamilyLabReport(imageFile!, reportTitle.text, lName.text, context, widget.existingUrl, widget.docId,widget.familyMemberId,widget.reportId);
                          }
