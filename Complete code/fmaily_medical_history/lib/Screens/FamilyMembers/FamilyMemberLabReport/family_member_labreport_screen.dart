...
import 'package:fmaily_medical_history/Screens/FamilyMembers/FamilyMemberLabReport/edit_family_labreport.dart';
...
import 'add_family_member_labreport.dart';

class FamilyLabReport extends StatefulWidget {
  const FamilyLabReport({Key? key,required this.familyMemberId,required this.reportId}) : super(key: key);
  final String familyMemberId;
  final String reportId;

  @override
  _FamilyLabReportState createState() => _FamilyLabReportState();
}

class _FamilyLabReportState extends State<FamilyLabReport> {
    ...
    return Scaffold(
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>AddFamilyLabReport(reportId: widget.reportId,familyMemberId: widget.familyMemberId,)));
          },
          child: const Icon(
            Icons.add,
            size: 40,
      ...
      body: Column(
        ...
        children: [
          ...
          Flexible(
              child: StreamBuilder(
                stream: getFamilyLabReportData(year,widget.familyMemberId,widget.reportId),
...
class CustomLabReportCard extends StatelessWidget {
  const CustomLabReportCard({super.key, required this.snapshot,required this.index,required this.reportId,required this.familyMemberId});
  final int index;
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: (){
                                  Navigator.pop(context);
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>EditFamilyLabReport(
                                      lName: snapshot.docs[index]['Laboratory name'],
                                      reportTitle: snapshot.docs[index]['Report title'],
                                      docId: snapshot.docs[index].id,
                                      existingUrl: snapshot.docs[index]['image'],
                                              ...
                                              Expanded(
                                                child: ElevatedButton(
                                                  onPressed: (){
                                                    ...
                                                    deleteFamilyLabReportData(snapshot.docs[index]['image'], snapshot.docs[index].id,context,familyMemberId,reportId);
                                                  },
