...
class FamilyEditVaccination extends StatefulWidget {
  const FamilyEditVaccination({Key? key,required this.hName,required this.vName,required this.vDate,required this.vtime,required this.id,required this.vaccinationId,required this.familyMemberId}) : super(key: key);
  final String vName;
  final String hName;
  final String vDate;
  final String vtime;
  ...
  @override
  _FamilyEditVaccinationState createState() => _FamilyEditVaccinationState();
}

class _FamilyEditVaccinationState extends State<FamilyEditVaccination> {
              ...
              child: ElevatedButton(
                onPressed: textReadOnly?null:(){
                  ...
                  if(!_form.currentState!.validate())
                  {
                    ...
                    editFamilyVaccination(vName.text, hName.text, date.text, time.text, widget.id,widget.vaccinationId,widget.familyMemberId).then((value){
                      Navigator.pop(context);
                      setState(() {
                        textReadOnly=true;
                      });
