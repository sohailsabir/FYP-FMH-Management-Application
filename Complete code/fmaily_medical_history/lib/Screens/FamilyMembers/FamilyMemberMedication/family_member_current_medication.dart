...
import 'package:fmaily_medical_history/Screens/FamilyMembers/FamilyMemberMedication/family_edit_medication_screen.dart';
...
class FamilyCurrentMedicationScreen extends StatefulWidget {
  const FamilyCurrentMedicationScreen({Key? key,required this.medicineId,required this.familyMemberId}) : super(key: key);
  final String medicineId;
  final String familyMemberId;

  @override
  _FamilyCurrentMedicationScreenState createState() =>
      _FamilyCurrentMedicationScreenState();
}

class _FamilyCurrentMedicationScreenState extends State<FamilyCurrentMedicationScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Flexible(
            child: StreamBuilder(
              stream: getFamilyCurrentMedicationData(widget.medicineId),
              builder: (context, AsyncSnapshot snapshot){
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context,int index){
                    if(mName.isEmpty)
                    {
                      return FamilyCurrentMedicationContainer(
                        snapshot: snapshot.data,
                        index: index,
                        familyMemberId: widget.familyMemberId,
                        medicationId: widget.medicineId,
                      );
                    }
...
class FamilyCurrentMedicationContainer extends StatelessWidget {
  const FamilyCurrentMedicationContainer({Key? key,required this.snapshot,required this.index,required this.medicationId,required this.familyMemberId}) : super(key: key);
  final int index;
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        FocusManager.instance.primaryFocus!.unfocus();
        Navigator.push(context, MaterialPageRoute(builder: (context)=>FamilyEditMedication(medicineName: snapshot.docs[index]['Medicine name'],
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: ElevatedButton(
                                                      onPressed: (){
                                                        deleteFamilyMedication(docId,familyMemberId,medicationId);
                                                        Navigator.pop(context);
                                                      },
