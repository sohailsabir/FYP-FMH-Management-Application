...
class FamilyAllMedicationScreen extends StatefulWidget {
  const FamilyAllMedicationScreen({Key? key,required this.medicineId,required this.familyMemberId}) : super(key: key);
  final String medicineId;
  final String familyMemberId;

  @override
  _FamilyAllMedicationScreenState createState() => _FamilyAllMedicationScreenState();
}

class _FamilyAllMedicationScreenState extends State<FamilyAllMedicationScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Flexible(
            child: StreamBuilder(
              stream: getFamilyAllMedicationData(year, widget.medicineId),
...
class AllMedicationContainer extends StatelessWidget {
  const AllMedicationContainer({Key? key,required this.snapshot,required this.index,required this.medicationId,required this.familyMemberId}) : super(key: key);
  final int index;
