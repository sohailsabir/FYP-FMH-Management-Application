...
import 'package:fmaily_medical_history/Screens/Vaccinations/add_vacination.dart';
import 'package:fmaily_medical_history/Screens/Vaccinations/edit_vaccination_screen.dart';
import 'package:fmaily_medical_history/Screens/Vaccinations/vaccination_pdf_custom.dart';
...
class _VaccinationScreenState extends State<VaccinationScreen> {
  ...
  getMedicationData(int num)async{
    ...
    await FirebaseFirestore.instance.collection('User').doc(uid).collection('Vaccination').get().then((value){
      if(num==1)
      {
                    ...
                    actions: [
                      Center(
                        child: ElevatedButton(onPressed: (){
                          Navigator.pop(context);
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const VaccinationCustomPDF()));
                        },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: kprimarycolor,
      ...
      body: Column(
        children: [
          ...
          Flexible(child: StreamBuilder(
            stream: getAllVaccinationData(year),
...
class VaccinationContainer extends StatelessWidget {
  const VaccinationContainer({Key? key,required this.snapshot,required this.index}) : super(key: key);
...
final int index;
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>EditVaccination(
