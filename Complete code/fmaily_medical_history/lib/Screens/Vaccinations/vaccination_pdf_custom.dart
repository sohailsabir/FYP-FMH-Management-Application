...
class VaccinationCustomPDF extends StatefulWidget {
  const VaccinationCustomPDF({Key? key}) : super(key: key);

  @override
  _VaccinationCustomPDFState createState() => _VaccinationCustomPDFState();
}

class _VaccinationCustomPDFState extends State<VaccinationCustomPDF> {
  List pdfdata = [];
  var userData;
