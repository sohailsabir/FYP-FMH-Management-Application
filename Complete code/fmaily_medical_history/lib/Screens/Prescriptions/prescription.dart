...
import 'package:fmaily_medical_history/Screens/Prescriptions/edit_prescription.dart';
...
import 'package:fmaily_medical_history/Screens/Prescriptions/add_prescription.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          ...
          onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (context)=>const AddPrescription()));
          },
          child: const Icon(
            Icons.add,
            size: 40,
      ...
      body: Column(
        ...
        children: [
          ...
          Flexible(
              child: StreamBuilder(
                stream: getPrescriptionData(year),
...
class CustomPrescriptionCard extends StatelessWidget {
  const CustomPrescriptionCard({super.key, required this.snapshot,required this.index});
  final int index;
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                onTap: (){
                                  Navigator.pop(context);
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>EditPrescription(
                                              ...
                                              Expanded(
                                                child: ElevatedButton(
                                                  onPressed: (){
                                                    ...
                                                    deletePrescriptionData(snapshot.docs[index]['image'], snapshot.docs[index].id,context);
                                                  },
